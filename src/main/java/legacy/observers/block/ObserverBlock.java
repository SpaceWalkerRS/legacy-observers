...
public class ObserverBlock extends Block {
	...
	public void neighborStateChanged(World world, int x, int y, int z, Block neighborBlock, int neighborX, int neighborY, int neighborZ) {
	...
	protected void updateNeighbors(World world, int x, int y, int z, int metadata) {
		...
		world.neighborChanged(behindX, behindY, behindZ, this);
